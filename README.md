...
ao-mission gateway readiness-rollup --suite <suite.json> --a2a-compatibility <compatibility.json> --archive-validation <archive-validation.json> --snapshot-diff <snapshot-diff.json> --out <rollup.json>

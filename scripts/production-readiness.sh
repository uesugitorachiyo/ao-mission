...
jq -e '.schema == "ao.mission.atlas-wave-final-synthesis.v0.1" and .status == "completed" and .mission == "ao-mission-atlas-wave-import-v01" and .completed_nodes == 25 and .ready_nodes == 0 and .blocked_nodes == 0 and .final_response_allowed == true and .promotion_claimed == false and .claims_authority_advance == false and .rsi_remains_denied == true and (.feature_depth_recommendations | length >= 10)' docs/evidence/ao-mission-atlas-wave-import-v01/final-synthesis.json >/dev/null
